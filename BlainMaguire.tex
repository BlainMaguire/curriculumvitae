% Blain Maguire's CV
% A LaTeX resume using res.cls
% I got it from here: http://www.rpi.edu/dept/arc/training/latex/resumes/
% There are many templates using it to choose from - I picked res9b.tex as a base and customized it.
% LaTex for github/linkedin icons is not my own, I found both on stackexchange from a google search.

\documentclass[line,margin,final]{res} 
\usepackage{marvosym}
\usepackage{url}
...
\address{\Letter \hspace{1 mm} maguirbm@tcd.ie \hspace{1 mm} \Mobilefone \hspace{1 mm} 085 777 00 35}
...
\section{Education}
					...
					{\sl MSc Computer Science} \hfill  \textcolor{light-gray}{ 2011 - 2012}\\ \\              
                	\textbf{National University of Ireland Maynooth} \hfill Kildare, Ireland\\
					{\sl BSc Computer Science with Software Engineering} \hfill \textcolor{light-gray}{ 2005 - 2010}
 
\section{Experience}
					\textbf{Deloitte Touche Tohmastsu Ltd} \hfill Dublin, Ireland\\
					{\sl Java EE related Consulting} \hfill \textcolor{light-gray}{ Jul 10 - Sep 11}
					
                 	\begin{itemize}  \itemsep -2pt % reduce space between items
                 	\item Implemented and maintained enterprise Java applications for clients in the public sector using technologies like Sping, Hibernate and JMS.
                 	\item Implemented scripts to migrate legacy relational database data to comply with new EU legislation.
                	\item Worked closely with clients and business analysts drafting and eliciting requirements.

                	\end{itemize}
                	
                	\textbf{Microsoft Ireland Operations Ltd} \hfill Dublin, Ireland\\
					{\sl Software Development Engineer in Test (Intern)} \hfill \textcolor{light-gray}{ Feb 08 - Apr 09}
					
                 	\begin{itemize}  \itemsep -2pt % reduce space between items
                 	\item Implemented and maintaned internal tools in C\# (some C++) relating to localization for Microsoft Office with a focus on test automation.
                 	
					\item Supported the test teams and assisted with authoring and maintaining of test cases.

                	\end{itemize}
                	
                	\textbf{Digital Interactive Media Enterprises Ltd} \hfill Dublin, Ireland\\
					{\sl Freelance Software Developer, Consultant (Part-Time)}\hfill\textcolor{light-gray}{ Apr 09 - Sep 09 }
					\begin{itemize} \itemsep -2pt % reduce space between items
					\item Wrote an CRM tool for internal use at the company in Java.
					\item Gave technical advice to clients and assisted them with issues.
					\end{itemize}

\section{Skills}
           \begin{description}
           \item[Main Areas of Expertise:] \hfill \\
			Full Stack Web Applications {\sl(Spring, Django)}\\
			Desktop Applications {\sl(Swing, TK, wxWidgets, OpenGL, DirectX)}\\
            Machine Learning {\sl(Evolutionary Computation, Artificial Neural Networks)}\\
            Mobile Applications {\sl \href{https://play.google.com/store/search?q=com.blainmaguire\&c=apps}{(Android 2.2 SDK with some NDK)}} \\
            \item[Main Languages:] \hfill \textcolor{light-gray}{(In order of preference)}\\
            {\sl Python, C\#, Java, C, C++}
            \item[Working Knowledge of:] \hfill \\
            JavaScript, ActionScript, HTML/CSS, PHP, Perl, Ruby, Lua, Lisp
            \item[System Adminstration:] \hfill \\
			Linux/Solaris servers, Linux user, some Windows Server
			\item[Version Control and Build Tools:] \hfill \\
			CVS, Subversion, Git, Mercurial, Make, Maven, Ant, Hudson
            \end{description}
\section{Other}
            \github{\url{http://github.com/BlainMaguire}}\\
            \linkedin{\url{http://linkedin.com/in/blainmaguire}}\\
            \Mundus~\url{http://blainmaguire.com}\\
\end{resume}
\end{document}
