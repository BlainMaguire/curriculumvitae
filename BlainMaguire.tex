...
\name{Blain Maguire}
\address{ \Letter \hspace{1 mm} maguirbm@tcd.ie \hspace{2 mm} \Mobilefone \hspace{1 mm} 085 777 00 35 \hspace{2 mm} \Mundus \hspace{1 mm} Dublin, Ireland}

\begin{resume} 
 
\section{Education}
           \begin{description}
           \item[Trinity College Dublin] \hfill \\
					{\sl Masters in Computer Science} \hfill \textcolor{light-gray}{ 2011}\\             
           \item[Maynooth University] \hfill \\
					{\sl Bachelors in Computer Science with Software Engineering} \hfill \textcolor{light-gray}{2005}
		   \end{description}
 
\section{Experience}

					\textbf{Zarion Ltd }\hfill 1 year, 6 months+\\
					{\sl Software Engineer (Full Stack)} \hfill \textcolor{light-gray}{ Apr 13 - Present}
					\begin{itemize} \itemsep -2pt % reduce space between items
					\item Backend SOA web applications with RESTful APIs in C\# and Node.js
					\item Frontend using Twitter Bootstrap, LESS and MVVM JavaScript (Knockout/Angular)
					\item NoSQL data modeling using MongoDB, Redis and ElasticSearch
					\end{itemize}

					\textbf{Deloitte Touche Tohmastsu Ltd} \hfill 1 year, 3 months\\
					{\sl Java EE related Consulting (Backend)} \hfill \textcolor{light-gray}{ Jul 10 - Sep 11}
                	...
                	\item Worked closely with business analysts drafting and eliciting requirements.

                	\end{itemize}
                	
                	\textbf{Microsoft Ireland Operations Ltd} \hfill 1 year, 3 months\\
					...
					\item Supported the test teams. Assisted with authoring and maintaining of test cases.

                	\end{itemize}
                	
                	\textbf{Digital Interactive Media Enterprises Ltd} \hfill 6 months\\
					{\sl Freelance Software Developer}\hfill\textcolor{light-gray}{ Apr 09 - Sep 09 }

\section{Skills}
           \begin{description}
           \item[Main Areas of Expertise:] \hfill \\
			Backend Web Development \hfill {\sl NancyFX, Express.js, Spring, Flask/Django}\\
			Frontend Web Development \hfill {\sl Bootstrap, LESS, jQuery/Angular/Knockout}\\
            Machine Learning \hfill {\sl Evolutionary Computation, Deep Learning}\\
            Mobile Applications \hfill {\sl \href{https://play.google.com/store/search?q=com.blainmaguire\&c=apps}{Android 2.2 SDK with some NDK}}
...
\section{More}
			 \begin{description}
			 \item  \github{\url{http://github.com/BlainMaguire}}
	         \item  \linkedin{\url{http://linkedin.com/in/blainmaguire}}
	         \item  \Mundus~\url{http://blainmaguire.com}
             \end{description}
\end{resume}
\end{document}
